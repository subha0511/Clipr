...
/**
 * Might not be used Here as the id cannot be parsed in 7 alphanumeric letters [a-z][A-Z][0-9]
...
public class Snowflake {
    ...
    public static synchronized Snowflake getInstance(long nodeId, long customEpoch) {
        if (instance == null) {
            synchronized (Snowflake.class) {
                if (instance == null) {
                    instance = new Snowflake(nodeId, customEpoch);
                }
            }
        }
        return instance;
    ...
    public static synchronized Snowflake getInstance(long nodeId) {
        if (instance == null) {
            synchronized (Snowflake.class) {
                if (instance == null) {
                    instance = new Snowflake(nodeId);
                }
            }
        }
        return instance;
